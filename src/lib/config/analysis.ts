...
function buildTopicTest(patterns: RegExp[]): (text: string) => boolean {
	const combinedPattern = new RegExp(patterns.map(p => p.source).join('|'), 'i');
	return (text: string) => combinedPattern.test(text);
}
...
export const CORRELATION_TOPICS: CorrelationTopic[] = [
	{
		...
		category: 'Economy',
		test: buildTopicTest([/tariff/i, /trade war/i, /import tax/i, /customs duty/i])
	},
	{
		id: 'fed-rates',
		patterns: [/federal reserve/i, /interest rate/i, /rate cut/i, /rate hike/i, /powell/i, /fomc/i],
		category: 'Economy',
		test: buildTopicTest([/federal reserve/i, /interest rate/i, /rate cut/i, /rate hike/i, /powell/i, /fomc/i])
	},
	{
		id: 'inflation',
		patterns: [/inflation/i, /cpi/i, /consumer price/i, /cost of living/i],
		category: 'Economy',
		test: buildTopicTest([/inflation/i, /cpi/i, /consumer price/i, /cost of living/i])
	},
	{
		id: 'ai-regulation',
		patterns: [/ai regulation/i, /artificial intelligence.*law/i, /ai safety/i, /ai governance/i],
		category: 'Tech',
		test: buildTopicTest([/ai regulation/i, /artificial intelligence.*law/i, /ai safety/i, /ai governance/i])
	},
	{
		id: 'china-tensions',
		patterns: [/china.*taiwan/i, /south china sea/i, /us.*china/i, /beijing.*washington/i],
		category: 'Geopolitics',
		test: buildTopicTest([/china.*taiwan/i, /south china sea/i, /us.*china/i, /beijing.*washington/i])
	},
	{
		id: 'russia-ukraine',
		patterns: [/ukraine/i, /zelensky/i, /putin.*war/i, /crimea/i, /donbas/i],
		category: 'Conflict',
		test: buildTopicTest([/ukraine/i, /zelensky/i, /putin.*war/i, /crimea/i, /donbas/i])
	},
	{
		id: 'israel-gaza',
		patterns: [/gaza/i, /hamas/i, /netanyahu/i, /israel.*attack/i, /hostage/i],
		category: 'Conflict',
		test: buildTopicTest([/gaza/i, /hamas/i, /netanyahu/i, /israel.*attack/i, /hostage/i])
	},
	{
		id: 'iran',
		patterns: [/iran.*nuclear/i, /tehran/i, /ayatollah/i, /iranian.*strike/i],
		category: 'Geopolitics',
		test: buildTopicTest([/iran.*nuclear/i, /tehran/i, /ayatollah/i, /iranian.*strike/i])
	},
	{
		id: 'crypto',
		patterns: [/bitcoin/i, /crypto.*regulation/i, /ethereum/i, /sec.*crypto/i],
		category: 'Finance',
		test: buildTopicTest([/bitcoin/i, /crypto.*regulation/i, /ethereum/i, /sec.*crypto/i])
	},
	{
		id: 'housing',
		patterns: [/housing market/i, /mortgage rate/i, /home price/i, /real estate.*crash/i],
		category: 'Economy',
		test: buildTopicTest([/housing market/i, /mortgage rate/i, /home price/i, /real estate.*crash/i])
	},
	{
		id: 'layoffs',
		patterns: [/layoff/i, /job cut/i, /workforce reduction/i, /downsizing/i],
		category: 'Business',
		test: buildTopicTest([/layoff/i, /job cut/i, /workforce reduction/i, /downsizing/i])
	},
	{
		id: 'bank-crisis',
		patterns: [/bank.*fail/i, /banking crisis/i, /fdic/i, /bank run/i],
		category: 'Finance',
		test: buildTopicTest([/bank.*fail/i, /banking crisis/i, /fdic/i, /bank run/i])
	},
	{
		id: 'election',
		patterns: [/election/i, /polling/i, /campaign/i, /ballot/i, /voter/i],
		category: 'Politics',
		test: buildTopicTest([/election/i, /polling/i, /campaign/i, /ballot/i, /voter/i])
	},
	{
		id: 'immigration',
		patterns: [/immigration/i, /border.*crisis/i, /migrant/i, /deportation/i, /asylum/i],
		category: 'Politics',
		test: buildTopicTest([/immigration/i, /border.*crisis/i, /migrant/i, /deportation/i, /asylum/i])
	},
	{
		id: 'climate',
		patterns: [/climate change/i, /wildfire/i, /hurricane/i, /extreme weather/i, /flood/i],
		category: 'Environment',
		test: buildTopicTest([/climate change/i, /wildfire/i, /hurricane/i, /extreme weather/i, /flood/i])
	},
	{
		id: 'pandemic',
		patterns: [/pandemic/i, /outbreak/i, /virus.*spread/i, /who.*emergency/i, /bird flu/i],
		category: 'Health',
		test: buildTopicTest([/pandemic/i, /outbreak/i, /virus.*spread/i, /who.*emergency/i, /bird flu/i])
	},
	{
		id: 'nuclear',
		patterns: [/nuclear.*threat/i, /nuclear weapon/i, /atomic/i, /icbm/i],
		category: 'Security',
		test: buildTopicTest([/nuclear.*threat/i, /nuclear weapon/i, /atomic/i, /icbm/i])
	},
	{
		id: 'supply-chain',
		patterns: [/supply chain/i, /shipping.*delay/i, /port.*congestion/i, /logistics.*crisis/i],
		category: 'Economy',
		test: buildTopicTest([/supply chain/i, /shipping.*delay/i, /port.*congestion/i, /logistics.*crisis/i])
	},
	{
		id: 'big-tech',
		patterns: [/antitrust.*tech/i, /google.*monopoly/i, /meta.*lawsuit/i, /apple.*doj/i],
		category: 'Tech',
		test: buildTopicTest([/antitrust.*tech/i, /google.*monopoly/i, /meta.*lawsuit/i, /apple.*doj/i])
	},
	{
		id: 'deepfake',
		patterns: [/deepfake/i, /ai.*misinformation/i, /synthetic media/i],
		category: 'Tech',
		test: buildTopicTest([/deepfake/i, /ai.*misinformation/i, /synthetic media/i])
	}
];
